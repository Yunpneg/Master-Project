...
print("Intra_class average distance for Feature Vectors", ("%.2f" % intra_ave_feature))
...
print("Inter_class average distance for Feature Vectors", ("%.2f" % inter_ave_feature))
